...
import {
  Popover,
  type PopoverRefResponse,
} from "../../../../libs/components/popover";
import {
  Box,
  Button,
  Divider,
...
export const ImageGenPreviewTemplate: React.FC = () => {
  ...
  const { templates, loading, status, setStatus } = useTemplateStore();
                ...
                <button
                  ...
                  onClick={() => {
                    addImagenToTemplateFlow({
                      imagenId: generatedImages[format || "generate"].id,
                      id: selectedTemplate,
                    });
                  }}
                >
