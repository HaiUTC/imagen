...
import { imagenDownloadFlow } from "../../../../flow/imagen.dowload.flow";
...
const ImageGenPreviewDownload: React.FC = () => {
  const popoverRef = useRef<PopoverRefResponse>(null);
  const [active, setActive] = useState<boolean>(false);
  const { loadingDownload } = useImagenStore();
      ...
      <Box width="320px">
        ...
        <Box paddingInline="300" paddingBlockEnd="200" paddingBlockStart="400">
          <button
            ...
            onClick={() => imagenDownloadFlow(downloadSettings)}
          >
